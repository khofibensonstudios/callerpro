...
FILES = [
    ("src/middleware.ts", "/var/www/connect-pro/web/src/middleware.ts"),
    ("src/app/robots.ts", "/var/www/connect-pro/web/src/app/robots.ts"),
    ("src/app/live/[id]/page.tsx", "/var/www/connect-pro/web/src/app/live/[id]/page.tsx"),
]
