...
def main():
    ...
    run(
        c,
        "mkdir -p /var/www/connect-pro/web/src/app/api/live/[id]/comments "
        "/var/www/connect-pro/web/src/app/api/live/[id]/hearts "
        "/var/www/connect-pro/web/src/app/api/live/[id]/guests "
        "/var/www/connect-pro/web/src/components",
        30,
    )
    s = c.open_sftp()
